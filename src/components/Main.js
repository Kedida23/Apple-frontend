		...
		<div>
			...
			<section className="first-hightlight-wrapper">
				<div className="container">
					...
					<div className="title-wraper bold black ipad">iPad Pro</div>
			...
			<section className="second-hightlight-wrapper">
				<div className="container">
					...
					<div className="title-wraper bold black MacBook">MacBook Air</div>
			...
			<section class="third-hightlight-wrapper">
				<div class="container">
					<div class="title-wraper bold iphone11 iphone">iPhone 11 Pro</div>
